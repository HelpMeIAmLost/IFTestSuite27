...
class PostFlashPreTestCheck(object):
    ...
    def get_stub_version(self, msg1, msg2):
        ...
        if tries == 10:
            ...
            if response_message.data[0] == 0xFF:
                logging.info(
                    'Stub version (Main): {}'.format(hex(response_message.data[1]))
                )
                print('Stub version (Main): {}'.format(hex(response_message.data[1])))
                sys.stdout.flush()
                ...
                if tries == 10:
                    ...
                    if response_message.data[0] == 0xFF:
                        logging.info(
                            'Stub version (Sub):  {}'.format(hex(response_message.data[1]))
                        )
                        print('Stub version (Sub):  {}'.format(hex(response_message.data[1])))
                        sys.stdout.flush()
                    elif response_message.data[0] == 0x20:
